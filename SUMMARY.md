...
* [操作列表](text/processing-list/README.md)
  * [常见的列表遍历方法](text/processing-list/chang-jian-de-lie-biao-bian-li-fang-fa.md)
...
* [本地使用python](text/local_use_python/README.md)
  * [windows下安装Python](text/local_use_python/windows-python.md)
  * [mac下安装python](text/local_use_python/mac_python.md)
  * [Python的使用（windows）](text/local_use_python/use_python.md)
  * [cmd工具](text/local_use_python/cmd.md)
* [模块安装与调用](text/module/README.md)
  * [模块调用](text/module/use_module.md)
  * [模块安装](text/module/install_module.md)
* [实战](text/shi-zhan.md)
